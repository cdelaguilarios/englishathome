...
function cargarLista() {
  ...
  if (urlListar !== "" && urlPerfilProfesorPostulante !== "" && urlPerfil !== "" && urlEditar !== "" && urlEliminar !== "" && estados !== "" && estadosDisponibleCambio !== "" && estadoProfesorRegistrado !== "") {
      ...
      columns: [
        ...
        {data: "estado", name: "entidad.estado", render: function (e, t, d, m) {
            if (estados[d.estado] !== undefined && estadosDisponibleCambio[d.estado] !== undefined) {
              return '<div class="sec-btn-editar-estado" data-idtabla="tab-lista-postulantes" data-idselestados="sel-estados" data-tipocambio="2">'+
        ...
        {data: "id", name: "entidad.id", orderable: false, "searchable": false, width: "5%", render: function (e, t, d, m) {
            return '<ul class="buttons">' +
                ...
                '</li>' +
                '<li>' +
                '<a href="javascript:void(0);" title="Eliminar alumno" onclick="utilTablas.eliminarElemento(this, \'¿Está seguro que desea eliminar los datos de este postulante?\', \'tab-lista-postulantes\')" data-id="' + d.id + '" data-urleliminar="' + ((urlEliminar.replace("/0", "/" + d.id))) + '">' +
      ...
      if (urlActualizarHorario !== "" && $(this).val() !== "") {
        ...
        util.llamadaAjax(urlActualizarHorario, "POST", {"horario": $(this).val()}, true,
            ...
            function (de) {
              $("body").unblock({
                onUnblock: function () {
                  mensajes.agregar("errores", "Ocurrió un problema durante la actualización del horario del postulante. Por favor inténtelo nuevamente.", true);
                }
              });
            }
        );
