  ...
  if (urlListarClases !== "" && urlPerfilAlumno !== "" && estadosClase !== "" && estadosPago !== "") {
    $("#tab-lista-clases").DataTable({
      ...
      "createdRow": function (r, d, i) {
        ...
        //Estado
        $("td", r).eq(5).addClass("text-center");
        $("td", r).eq(5).html('<span class="label ' + estadosClase[d.estado][1] + ' btn_estado">Clase - ' + estadosClase[d.estado][0] + '</span>' + (d.estadoPago !== null ? '<br/><span class="label ' + estadosPago[d.estadoPago][1] + ' btn_estado">Pago ' + estadosPago[d.estadoPago][0] + '</span>' : ''));
      }
    });
  }
