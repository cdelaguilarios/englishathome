var formularioComentariosClase = {};
formularioComentariosClase = (function ()/* - */ {
  ...
  function cargarFormulario()/* - */ {
    $("#formulario-comentarios-clase").validate({
      rules: {
        comentario: {
          required: true
        }
      ...
      submitHandler: function (f) {
        if (confirm("¿Está seguro que desea guardar los comentarios de la clase seleccionada?")) {
          ...
          util.llamadaAjax($(f).attr("action"), "POST", datos, true,
                  ...
                  function (d) {
                    $("#mod-comentarios-clase").modal("hide");
                    $("#formulario-comentarios-clase").find("textarea[name='comentario']").val("");
                    $("#formulario-comentarios-clase").find("input[name='idClase']").val("");
  ...
  function abrirModal(idClase)/* - */ {
    ...
    $("#formulario-comentarios-clase").find("textarea[name='comentario']").val("");
    $("#formulario-comentarios-clase").find("input[name='idClase']").val(datosFila.id);
    $("#mod-comentarios-clase").modal("show");
  }
