...
<div class="row text-center">
  <h4>
    ...
    @else
    Usted ya está registrado como alumno en nuestro sistema, para cualquier información comuniquese con nosotros al {{ App\Models\VariableSistema::obtenerXLlave("telefonosCelulares") }}.
    @endif
  </h4>
</div>
@else
