    ...
    <div class="sec-datos">
      <div class="box-body">
        <div class="pagina-impresion">
          ...
          <div class="sec-mapa">
            <img id="img-mapa" src="http://maps.google.com/maps/api/staticmap?sensor=false&center={{ $alumno->geoLatitud }},{{ $alumno->geoLongitud }}&zoom=17&size=800x525&markers=color:0x3C8DBC|{{ $alumno->geoLatitud }},{{ $alumno->geoLongitud }}&key={{ Config::get("eah.apiKeyGoogleMaps") }}" />
          </div>
          <hr>
        </div>   
        <div>
