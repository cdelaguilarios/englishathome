        ...
        <td class="header container">
          <div class="content">
            <table bgcolor="#084C9E" class="">
              <tr>
                <td align="center">
                  <span>Fijo: 3334306  Cel. 970883890</span>
                </td>				
                <td align="center"></td>
                <td align="center">
                  <span>Dirección: Jr. Loma de las Gardenias 235 - Surco</span>
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="column-wrap">
            ...
            <div>
              <table width="100%">
                <tr>
                  <td class="center">
                    <p><a href="www.englishathome.pe">www.englishathome.pe</a></p>
                ...
                <td align="center">
                  ...
                  <div class="sec-nuestra-empresa">
                    ...
                    <div class="justify contenido">					
                      Para conocer y obtener mas información acerca de nosotros, visite nuestra pagina web <a href="www.englishathome.pe">www.englishathome.pe</a>
                    </div>
                  </div>
                    ...
                    <table class="sec-cuentas-bancarias">
                      <tr>
                        <td class="center">
                          ...
                          Ahorro Soles: 194-34310254-0-21
                        </td>
                        <td class="center">
                          <img src="{{ asset("assets/eah/img/interbank.jpg") }}" width="110"/><br/>
                          Ahorros Soles : 379-3074633210
                        </td>
                      </tr>
                      <tr>
                        <td class="center">
                          <img src="{{ asset("assets/eah/img/scotiabank.jpg") }}" width="110"/><br/> 
                          Ahorros Soles: 068-7415372
                        </td>
                        <td class="center">
                          <img src="{{ asset("assets/eah/img/banco-continental.jpg") }}" width="110"/><br/> 
                          Ahorro Soles: 001102610200199839
                        </td>
                      </tr>
                    </table>
                    <div class="justify contenido">	
                      Cuentas a nombre de G. Fernando Rios H. Representante Legal de Capacidad Empresarial EIRL.
                    </div>
                  </div>
                  <table class="sec-mensaje-guia" bgcolor="#084C9E">
                    <tbody>
                      <tr>
                        <td></td>
                        <td class="container">
                          <a href="https://drive.google.com/open?id=0B0Fn2_yDU8iHNU5Fd2pnbmdSX2s">Es importante que pueda leer nuestra GUÍA DEL ALUMNO y brindarnos su conformidad ¡CLIC AQUÍ!</a>
                        </td>
                        <td>
                        </td>
                      </tr>
