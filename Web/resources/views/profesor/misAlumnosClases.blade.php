...
<script type="text/javascript">
  var urlListar = "{{ route('profesores.mis.alumnos.listar.clases', ['id' => $idAlumno]) }}";
    ...
    <div id="mod-confirmar-clase" class="modal" data-keyboard="false" style="text-align: initial">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          {{ Form::open(["url" => route("profesores.mis.alumnos.clases.confirmar", ['id' => $idAlumno]), "id" => "formulario-confirmar-clase", "class" => "form-horizontal", "novalidate" => "novalidate", "files" => true]) }}
...
<div id="mod-comentarios" class="modal" data-keyboard="false" style="text-align: initial">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      {{ Form::open(["url" => route("profesores.mis.alumnos.clases.actualizar.comentarios", ['id' => $idAlumno]), "id" => "formulario-comentarios", "class" => "form-horizontal", "novalidate" => "novalidate", "files" => true]) }}
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-12">
            <div class="box-body">
