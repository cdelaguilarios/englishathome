...
<script src="{{ asset("assets/eah/js/modulos/usuario/lista.js")}}"></script>
@endsection
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <div class="form-group">          
          ...
          <div class="col-sm-3">
            {{ Form::select("estado", App\Helpers\Enum\EstadosUsuario::listarBusqueda(), App\Helpers\Enum\EstadosUsuario::Activo, ["id"=>"bus-estado", "class" => "form-control", "placeholder" => "Todos", "data-idtabla" => "tab-lista-usuarios"]) }}
          </div>
        </div> 
      </div>
    </div>
...
<div class="row">
  <div class="col-sm-12">
    <div class="box box-info">
      ...
      <div class="box-body">
        <table id="tab-lista-usuarios" class="table table-bordered table-hover">
          <thead>
            <tr>
              <th>N°</th> 
