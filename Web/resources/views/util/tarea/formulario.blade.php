...
<div class="box-body">
  ...
  <div class="form-group">
    {{ Form::label("mensaje-tarea", "Descripción (*): ", ["class" => "col-sm-2 control-label"]) }}
    <div class="col-sm-10">
  ...
  <div id="sec-tareas-programacion">   
    ...
    <div id="sec-tareas-fecha-programada" class="form-group"> 
  ...
  <div class="form-group"> 
    {{ Form::label("fecha-finalizacion-tarea", "Fecha de finalización ", ["class" => "col-sm-2 control-label"]) }}
    <div class="col-sm-4">
      <div class="input-group date">
        <div class="input-group-addon">
          <i class="fa fa-calendar"></i>
        </div>                                
        {{ Form::text("fechaFinalizacion", null, ["id" => "fecha-finalizacion-tarea", "class" => "form-control", "placeholder" => "dd/mm/aaaa HH:mm:ss"]) }}
      </div>
    </div> 
  </div> 
  {{ Form::hidden("idTarea") }} 
